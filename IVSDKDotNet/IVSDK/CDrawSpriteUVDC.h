...
public:
	...
	{
		static void(__thiscall* fn)(CDrawSpriteUVDC*, CVector2D*, CVector2D*, CVector2D*, CVector2D*, CVector2D*, CVector2D*, CVector2D*, CVector2D*, CRGBA, CSprite2d) = injector::GetBranchDestination(AddressSetter::Get("CDrawSpriteUVDC", "CDrawSpriteUVDC")).get();
        fn(this, bl, tl, br, tr, bl2, tl2, br2, tr2, color, sprite);
	}
};
